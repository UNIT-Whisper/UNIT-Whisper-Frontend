...
function ChatPage() {
  ...
  return (
    <>
      <div className="max-w-[480px] w-full h-[1080px] bg-[#F1F8FD] m-auto relative">
        <div className="w-full h-16 py-[14px] flex pl-5 bg-white">
          <button>뒤로가기</button>
        </div>
        <div className="px-5 mb-[61px] absolute top-[89%] w-full z-30">
          <div className="py-3 px-4 w-full gap-1 flex items-center rounded border border-solid bg-white">
            <textarea
              value={data}
              ref={textareaRef}
              onChange={onChange}
